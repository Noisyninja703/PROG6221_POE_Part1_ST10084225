...
namespace PROG6221_POE_Part_1
{
    ...
    class HomeLoanExpense : Expenses
    {
        ...
        {    
            ...
            monthlyAmount = ((homePurchasePrice - homeTotalDeposit) * (1 + (annualInterestRate / 100) * (RepayMonths / 12)) / 12); //All calculations are done during the runtime, this helps reduce the need to assign memory to more variables
